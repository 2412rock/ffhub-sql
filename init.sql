...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Videos' AND COLUMN_NAME = 'Views')
BEGIN
    ALTER TABLE Videos
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tags' AND COLUMN_NAME = 'IsSuggestion')
BEGIN
    ALTER TABLE Tags
    ADD IsSuggestion BIT NOT NULL DEFAULT 0;
END
